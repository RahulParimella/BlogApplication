...
public class AuthServiceImpl implements AuthService{
	...
	public String login(LoginDto loginDto) {
		...
		Authentication authenctication= authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(loginDto.getUsernameOrEmail(),
																		loginDto.getPassword()));
		
		SecurityContextHolder.getContext().setAuthentication(authenctication);
		
		String token =jwtTokenProvider.generateToken(authenctication);
	...
	public String register(RegisterDto registerDto) {
		...
		// add check for email exist in database or not
